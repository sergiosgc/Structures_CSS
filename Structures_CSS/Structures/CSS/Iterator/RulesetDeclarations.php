 ...
 * @package Structures_CSS
 */
class Structures_CSS_Iterator_RulesetDeclarations implements Iterator
{
    ...
    {
        $this->setInternalIterator(new Structures_CSS_Iterator_Array($ruleset->getDeclarations()));
    }
    /* }}} */
    /* Current {{{ */
