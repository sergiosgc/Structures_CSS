 ...
 * @package Structures_CSS
 */
class Structures_CSS_Iterator_AtMediaRules implements Iterator
{
     ...
     *
     */
    public function __construct($atmedia)
    {
        $this->setInternalIterator(new Structures_CSS_Iterator_Array($atmedia->getRules()));
    }
    /* }}} */
    /* Current {{{ */
