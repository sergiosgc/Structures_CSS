...
/**
 * CSS declaration margin class
 * @package Structures_CSS
 */
class Structures_CSS_Declaration_Margin extends Structures_CSS_Declaration_BoxModel
{
    /* expandShorthand {{{ */
    /**
    ...
    public function expandShorthand($deep = true)
    {
        ...
        return $this->_expandShorthand($deep, 
                               array(
                                'margin-top' => 'Structures_CSS_Value',
                                'margin-right' => 'Structures_CSS_Value',
                                'margin-bottom' => 'Structures_CSS_Value',
                                'margin-left' => 'Structures_CSS_Value'));
    }
    /* }}} */
    /* collapseShorthand {{{ */
    /**
    ...
    public static function collapseShorthand(&$ruleset)
    {
        $result = parent::collapseShorthand($ruleset, 
                                  array(
                                   'margin-top' => array(0),
                                   'margin-right' => array(0),
                                   'margin-bottom' => array(0),
                                   'margin-left' => array(0)), 
                                  'margin', null, false);
        return $result;
    }
