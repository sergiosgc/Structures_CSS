 ...
 * @package Structures_CSS
 */
class Structures_CSS_Declaration_BorderLeft extends Structures_CSS_Declaration
{
    /* expandShorthand {{{ */
    /**
    ...
    public function expandShorthand($deep = true)
    {
        ...
        return $this->_expandShorthand($deep, 
                               array(
                                 'border-left-width' => 'Structures_CSS_Value_Unit',
                                 'border-left-style'  => 'Structures_CSS_Value_Generic',
