 ...
 * @package Structures_CSS
 */
class Structures_CSS_Declaration_BorderTop extends Structures_CSS_Declaration
{
    /* expandShorthand {{{ */
    /**
    ...
    public function expandShorthand($deep = true)
    {
        ...
        return $this->_expandShorthand($deep, 
                               array(
                                 'border-top-width' => 'Structures_CSS_Value_Unit',
                                 'border-top-style'  => 'Structures_CSS_Value_Generic',
