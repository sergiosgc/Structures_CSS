...
/**
 * CSS declaration pause class
 * @package Structures_CSS
 */
class Structures_CSS_Declaration_Pause extends Structures_CSS_Declaration
{
    /* expandShorthand {{{ */
    /**
    ...
    public function expandShorthand($deep = true)
    {
        ...
        return $this->_expandShorthand($deep, 
                               array(
                                'pause-before' => 'Structures_CSS_Value_Unit',
                                'pause-after' => 'Structures_CSS_Value_Unit'));
    }
    /* }}} */
    /* collapseShorthand {{{ */
    /**
